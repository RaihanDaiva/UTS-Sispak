...
export function SymptomCheckbox({ code, label, checked, onChange }) {
  return (
    <label className="flex items-start gap-3 p-4 bg-card rounded-xl border border-border hover:border-primary/50 cursor-pointer transition-all group">
      <input
        type="checkbox"
        checked={checked}
        onChange={onChange}
